    ...
    return (
        <div className="pic-and-desc">
            ...
            <div className="about-desc">
                <span className="main-subtitle"><b>2016</b> was the year I started programming in <b>Python</b>. My goal was to leverage my <b>knowledge of linguistics</b> to <b>build useful apps</b>.</span>
